...
labs = {
    ...
    "bio": {
            ...
            "status": "Active",
            "members": [ "Shrina Pandey", "Meeseo Lee", "Anisha Chandy", "Ishna Pandey", "Andrew Koh", "Tanirika Singh", "Jean Ye", "Ting Guo", "Jenny Wu", "Hank Wang", "Albert Wu","Sanghwi Samala", "Serena Chi", "Nancy Nguyen" ],
            "content": {
                "overview": {
