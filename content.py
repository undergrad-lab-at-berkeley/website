...
labs = {
    ...
    "physics": {
        ...
        "navbar": u"Physics",
        "status": "Active",
        "members": ["Jordan Duan", 'Andrew McHaty', 'Yaamini Jois', 'Brianna Peck', 'Caitlin Begbie', 'Andrew Wang', 'Michelle Duan', 'Olivia Wagner', 'Sophie Bucker'],
        "former": {
            'former_name': [
                'Arjun Savel',
                'Aditya Sengupta',],
