            ...
            "content": {
                "overview": {
                    ...
                    "text": u"""
                        ...
                        <br/><b>Feel free to reach out to us at</b> <a href="mailto:physicslab@ulab.berkeley.edu">physicslab@ulab.berkeley.edu</a> <b>with questions or concerns. If you would like to join our program as a mentee, mentor, or curriculum developer, applications can be found below. We also welcome involvement from gradaute students, postdocs, and faculty members! (More information below) 
                    """
                },
                "join": {
                    "title": u"Join Us!",
