    ...
    "compbio": {
        ...
        "content": {
            ...
            "join": {
                "title": "Join Us!",
                "text":u"""
                    Mentee & Mentor positions are now open for Fall 2023! If you would like to be considered for a role in our lab this semester, please fill out the respective forms below. The application deadline is extended to Saturday, September 16th @ 11:59PM for both mentors and mentees. Both mentors & mentees will hear back from us regarding the decision by Monday, September 18th; the deadline to accept our offer will be Tuesday, September 19th. Although the application deadline is after the course add/drop deadline, all members that hear from us before September 13th will be able to take our Decal for units. Our first class will be held on September 12th in the Social Sciences Building Room 56, and we welcome all potential members to attend, even if you are unsure of applying!
                    <br><br>
